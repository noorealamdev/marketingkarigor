...
@section('styles')
    ...
    .cta-banner .btn-whatsapp { background: #fff; color: #8a5f09; max-width: 320px; margin: 0 auto; }
    .cta-banner .btn-whatsapp:hover { background: #fff8ec; }
...
@section('content')
    ...
    <section id="why-us">
        <div class="wrap">
            ...
            @php
                $whys = [
                    ['সরাসরি যোগাযোগ', 'কোনো কল সেন্টার নয় — আপনার কাজ যিনি সরাসরি সামলাচ্ছেন, তার সাথেই সরাসরি কথা বলবেন।', '<path d="M21 11.5a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 01-7.6 4.7 8.38 8.38 0 01-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 01-.9-3.8 8.5 8.5 0 014.7-7.6 8.38 8.38 0 013.8-.9h.5a8.48 8.48 0 018 8v.5z"/>'],
        ...
        <div class="wrap">
            ...
            @php
                $faqs = [
                    ...
                    ['চুক্তি কীভাবে হয় — মাসিক নাকি নির্দিষ্ট মেয়াদী?', 'আপনার প্রয়োজন অনুযায়ী আমরা মাসিক ভিত্তিতে অথবা নির্দিষ্ট মেয়াদে — দুইভাবেই কাজ করি। শুরুতেই সরাসরি আলোচনা করে যেটা আপনার জন্য উপযুক্ত, সেভাবে এগোনো হয়।'],
    ...
    <section>
        <div class="wrap">
            <div class="cta-banner">
                ...
                <p>আজই আমাদের সাথে যোগাযোগ করুন এবং একটি পরিকল্পিত কনটেন্ট সিস্টেম শুরু করুন।</p>
                @if($wa)
                <a href="{{ $wa }}" target="_blank" rel="noopener" class="btn btn-whatsapp btn-lg">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M20 2H4a2 2 0 00-2 2v18l4-4h14a2 2 0 002-2V4a2 2 0 00-2-2z"/></svg>
                    এখনই যোগাযোগ করুন
