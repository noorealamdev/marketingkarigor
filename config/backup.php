...
return [
    ...
    'notifications' => [
        'notifications' => [
            // Only alert on problems — daily "backup succeeded" emails forever would just be noise.
            // The "successful" classes stay registered with no channels (rather than removed) because
            // the package throws if an event has no notification class mapped to it at all.
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL', 'noorealamdev@gmail.com'),
